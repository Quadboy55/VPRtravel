...
public partial class MasterPageLanden : System.Web.UI.MasterPage
{
    ...
    public void setTemperatuur(String City, String Land)
    {
        try
        {
            ...
            foreach (XmlNode xn in xnList)
            {
                ...
                lblTemp.Text = "<strong>Lokale temperatuur: </strong>" + s.Substring(index1 + 1, index2 - index1 - 1);
            }
        }
        catch (Exception ex)
        {
    ...
    public void setHotel(List<HotelData> hotels)
    {
        ...
        lblHotel2URL.Text = "Website";
        lblHotel2URL.Target = "_blank";
        lblHotel2URL.NavigateUrl = hotels[0].website;
        ...
        lblHotel3URL.Text = "Website";
        lblHotel3URL.Target = "_blank";
        lblHotel3URL.NavigateUrl = hotels[0].website;
    }

    public void setLandInfo(string info)
    {
        lblLandInfo.Text = info;
    }
}
